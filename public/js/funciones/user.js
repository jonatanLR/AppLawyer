...
$(document).ready(function () {
    var table;
            ...
            columns: [
               ...
               "width": "50px",
                "render":function (data) {
                    return '<a href="/user/edit/'+data+'" class="editar btn btn-sm btn-primary" title="Editar Usuario"><i class="fas fa-edit"></i></a>' + ' ' 
        ...
        $('#tableuser tbody').on('click', 'td.dt-control', function () {
        ...
        $('#tableuser tbody').on('click', 'td .delete', function () {
            var id = $(this).attr("id");
            var fila = $(this);
