...
$(document).ready(function () {
    var table;
            ...
            columns: [
               ...
               "width": "50px",
                "render":function (data) {
                    return '<a href="/cliente/edit/'+data+'" class="editar btn btn-sm btn-primary" title="Editar Cliente"><i class="fas fa-edit"></i></a>' + ' ' 
        ...
        $('#tablecliente tbody').on('click', 'td.dt-control', function () {
