 ...
 */
final class Version20230509064400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cliente (id INT AUTO_INCREMENT NOT NULL, persona_id INT NOT NULL, tipo_cc_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_F41C9B25F5F88DB9 (persona_id), INDEX IDX_F41C9B25AE9F2487 (tipo_cc_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contrario (id INT AUTO_INCREMENT NOT NULL, persona_id INT NOT NULL, tipo_cc_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_FFD95067F5F88DB9 (persona_id), INDEX IDX_FFD95067AE9F2487 (tipo_cc_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE juez (id INT AUTO_INCREMENT NOT NULL, persona_id INT DEFAULT NULL, numprofesion VARCHAR(8) NOT NULL, UNIQUE INDEX UNIQ_8FBF65008B6EB1AC (numprofesion), UNIQUE INDEX UNIQ_8FBF6500F5F88DB9 (persona_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE persona (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(150) NOT NULL, dni VARCHAR(15) NOT NULL, email VARCHAR(255) NOT NULL, direccion LONGTEXT DEFAULT NULL, telefono VARCHAR(8) DEFAULT NULL, UNIQUE INDEX UNIQ_51E5B69B7F8F253B (dni), UNIQUE INDEX UNIQ_51E5B69BE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE procurador (id INT AUTO_INCREMENT NOT NULL, persona_id INT NOT NULL, num_abogado VARCHAR(45) NOT NULL, UNIQUE INDEX UNIQ_30D459ED188870CC (num_abogado), UNIQUE INDEX UNIQ_30D459EDF5F88DB9 (persona_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tipo_cc (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tp_actuacion (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_3EB864AF3A909126 (nombre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cliente ADD CONSTRAINT FK_F41C9B25AE9F2487 FOREIGN KEY (tipo_cc_id) REFERENCES tipo_cc (id)');
        $this->addSql('ALTER TABLE contrario ADD CONSTRAINT FK_FFD95067F5F88DB9 FOREIGN KEY (persona_id) REFERENCES persona (id)');
        $this->addSql('ALTER TABLE contrario ADD CONSTRAINT FK_FFD95067AE9F2487 FOREIGN KEY (tipo_cc_id) REFERENCES tipo_cc (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cliente DROP FOREIGN KEY FK_F41C9B25AE9F2487');
        $this->addSql('ALTER TABLE contrario DROP FOREIGN KEY FK_FFD95067F5F88DB9');
        $this->addSql('ALTER TABLE contrario DROP FOREIGN KEY FK_FFD95067AE9F2487');
        ...
        $this->addSql('DROP TABLE tipo_cc');
